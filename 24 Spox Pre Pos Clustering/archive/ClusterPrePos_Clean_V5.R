...
# In a second attempt, we will try to test if OPXV positive samples are also
...
#
# Changes in V5:
# - use dataIn instead of data for plotting, filtering and
#   determination of the cut-off values
# - Compare the population-based cut-off value with the cut-off values 
#   as determined by the method comparison
# - Keep only data and plots used for the final analysis
# - Final version: check dependencies and functionality of R script
####
...
## Unify the format for the Age_groups variable
dataClustering_pre <- 
  dataClustering %>% 
...
# Export results for import to check for specificities
save(dataClustering_post, file = "output/dataClustering_post.RData")
...
export(file = "output/20204-06-19_Populations_based_Cutoff.xlsx", paramDataFrame_transpose_sep)
# Determine threshold 
threshold <-
