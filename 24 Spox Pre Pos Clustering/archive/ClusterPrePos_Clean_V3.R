...
plotCombinedAll <- 
  ggarrange(plotYoungAntigens, plotOldAntigens, 
            plotRatiosYoung, plotRatiosOld, 
            ncol = 2, nrow = 2, 
            heights = c(3,2.2), align = "hv",
            common.legend = TRUE, labels = c("e", "f", "g", "h"))

ggsave(filename ="output/plotCombinedAll.png", plotCombinedAll, width = 10, height = 8, 
       dpi = 600)

save(plotCombinedAll, file = "output/plotCombinedAll.Rdata")
