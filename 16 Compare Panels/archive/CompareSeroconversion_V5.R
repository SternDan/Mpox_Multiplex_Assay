...
plotRatios <-
  ggarrange(plotRatioIgG, plotRatioIgM, ncol = 2, align = "hv", labels = c("c", "d"),
            common.legend = TRUE)
...
plotPanelsCombined <- 
  ggarrange(plotStratifiedChildhood, plotRatios, plotCombinedAll, nrow = 3, align = "hv",
            common.legend = F, heights = c(3, 2, 6))

ggsave("output/plotPanelsCombined.png", plotPanelsCombined, width = 14, height = 18,
       dpi = 600)



ggsave("output/plotPanelsCombined.pdf", plotPanelsCombined, width = 16, height = 22,
       dpi = 600)
